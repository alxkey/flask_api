...
app.add_url_rule('/likes', defaults={'article_id': None, 'author_id': None, 'title': None, 'name': None}, view_func=api_like, methods=['DELETE', ])
app.add_url_rule('/likes/name/<title>&<name>', defaults={'article_id': None, 'author_id': None}, view_func=api_like, methods=['DELETE', ])
app.add_url_rule('/likes/<article_id>&<author_id>', defaults={'title': None, 'name': None}, view_func=api_like, methods=['DELETE', ])
...
app.add_url_rule('/comments', defaults={'article_id': None, 'author_id': None, 'title': None, 'name': None}, view_func=api_comment, methods=['DELETE', ])
app.add_url_rule('/comments/name/<title>&<name>', defaults={'article_id': None, 'author_id': None}, view_func=api_comment, methods=['DELETE', ])
app.add_url_rule('/comments/<article_id>&<author_id>', defaults={'title': None, 'name': None}, view_func=api_comment, methods=['DELETE', ])
